...
int main(void)	{
	...
	while(1)	{
		...
		{
			clearDisplay();
			GPIO->CLR[0] = (1UL<<SEG_A |1UL<<SEG_B | 1UL<<SEG_C | 1UL<<SEG_D | 1UL<<SEG_E |1UL<<SEG_F);//0
		}
		else if(adc_result <= 44)
		{
			clearDisplay();
			GPIO->CLR[0] = (1UL<<SEG_A |1UL<<SEG_B | 1UL<<SEG_C | 1UL<<SEG_D | 1UL<<SEG_G |1UL<<SEG_F);//9
		}
		else
		{
			clearDisplay();
